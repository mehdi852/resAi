            ...
            <div className="user">
                ...
                <Grid container direction="row">
                    ...
                    <Grid container className="user__left" item xs={12} md={12}>
                        ...
                        <TextField
                            onChange={(event) => {
                                this.handleInputs('userId', event.target.value);
                            }}
                        ...
                        <TextField
                            onChange={(event) => {
                                this.handleInputs('email', event.target.value);
                            }}
                            className="user__input"
                        ...
                        <TextField
                            ...
                            onChange={(event) => {
                                this.handleInputs('subscription', event.target.value);
                            }}
                            className="user__input"
                            select
                            id="outlined-basic"
                        ...
                        <TextField
                            ...
                            onChange={(event) => {
                                this.handleInputs('subscriptionEnd', event.target.value);
                            }}
