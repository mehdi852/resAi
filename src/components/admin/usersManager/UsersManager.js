            ...
            value.forEach((element) => {
                ...
                Rows.push(
                    this.createData(
                        ...
                        <img onClick={() => this.redirectToUser(element.userId, element.email, element.membership, element.membershipsEnds)} className="moreImage" src={MoreImage} />
                    )
                );
            });
                ...
                <Grid className="users__container" container>
                    ...
                    <Grid item md={6} lg={6} sm={12}>
                        <div className="users__search">
                            ...
                            <TextField
                                onChange={(event) => {
                                    this.handlInput('enteredUser', event);
                                }}
                                variant="outlined"
                                label="User email"
                            />
                    ...
                    <Grid className="users__all" item md={12}>
                        {this.state.showUsers == false ? (
                            <div className="show__users">
                                <Button onClick={() => this.showTable()} variant="outlined">
                                    Show users
                                </Button>
                            </div>
                        ) : (
