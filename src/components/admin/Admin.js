                        ...
                        <div className="admin__right">
                            ...
                            <div className="admin__navbar">
                                ...
                                <div className="admin__navbar-right">
                                    ...
                                    <a onClick={() => this.handleSidebarToggle()} className="admin__mobileToggle">
                                        {' '}
                                        Open{' '}
                                    </a>
                                </div>
                            ...
                            <Route exact path="/adm/phrases" component={Phrases} />
                            ...
                            <Route exact path="/adm/reviews" component={Reviews} />
