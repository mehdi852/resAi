            ...
            resumes[index] = (
                <li key={index} className="resumeItem">
                    ...
                    <div className="resumeItemContent">
                        ...
                        <div>
                            <Link onClick={() => this.setAsCurrentResume(this.state.resumes[index].id, JSON.stringify(this.state.resumes[index]))} className="btn-default btn-goResume" to={'/?step=3'}>
                                {' '}
                                Go To Resume
                            </Link>
                            <a onClick={() => this.deleteResume(localStorage.getItem('user'), this.state.resumes[index].id, index)} className="btn-default btn-removeResume">
                                Remove
                            </a>
                        </div>
                    </div>
                ...
                <div className="head">
                    <div className="headContent">
                        ...
                        {this.state.resumes != null && (
                            <Link onClick={() => addResume(localStorage.getItem('user'))} to="/" style={{ fontSize: '17px' }} className="btn-default">
                                {' '}
                                + {t('dashboard.addNew')}{' '}
                            </Link>
                        )}
