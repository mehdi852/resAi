...
class ActionFilling extends Component {
    ...
    constructor(props) {
        ...
        this.setOccupationError = this.setOccupationError.bind(this)
    ...
    newEmploymentField() {
        ...
        this.setState({
            employments: this.state.employments.concat([
                <Employment removeEmploymentJsx={this.removeEmploymentJsx} removeEmployment={this.props.removeEmployment} handleInputs={this.props.handleInputs} values={this.props.values} id={randomId} key={randomId} />,
            ]),
        });
    }
    //  Education History
    ...
    // set Occupation Error 
    setOccupationError (bool){
        this.setState({occupationError:bool})
    }
    render() {
        const { t } = this.props;
            ...
            <div id="introd" className="action-introWrapper filling">
                ...
                >
                    ...
                    <div className="grid-2-col">
                        ...
                        <SimpleInput setOccupationError={this.setOccupationError} error={this.state.occupationError} handleInputs={this.props.handleInputs} value={this.props.values.occupation} title={t('form.occupation')} name="Occupation" />
  ...
  */}
                    ...
                    <SimpleTextArea  setOccupationError={this.setOccupationError}  suggestions = {true}       categories={this.state.categories}      addSummary = {this.props.addSummary}name="Professional Summary" values={this.props.values} value={this.props.values.summary} handleInputs={this.props.handleInputs} title={t('form.profesionalSummary')} />
